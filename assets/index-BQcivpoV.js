...
`)+`
`+d);const S=C+f+o,w=C+d+a,R=fc(r,r.VERTEX_SHADER,S),D=fc(r,r.FRAGMENT_SHADER,w);r.attachShader(x,R),r.attachShader(x,D),e.index0AttributeName!==void 0?r.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function P(y){if(n.debug.checkShaderErrors){const W=r.getProgramInfoLog(x)||"",z=r.getShaderInfoLog(R)||"",X=r.getShaderInfoLog(D)||"",Y=W.trim(),j=z.trim(),K=X.trim();let k=!0,st=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(k=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,x,R,D);else{const ht=_c(r,R,"vertex"),Et=_c(r,D,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
